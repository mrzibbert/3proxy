...
Install :
    ...
    wget --no-check-certificate https://github.com/mrzibbert/3proxy/raw/main/3proxyinstall.sh
...
Uninstall:
	...
	wget --no-check-certificate https://github.com/mrzibbert/3proxy/raw/main/3proxyuninstall.sh
